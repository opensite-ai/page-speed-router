...
- Fixed ESM imports to include `.js` file extensions as required by Node.js ESM
- Added script to automatically fix import paths after TypeScript compilation
- Resolved "Cannot find module" errors in ESM environments
- Ensured all exports (useNavigation, useUrl, isBrowser, etc.) are properly accessible
